...
/**
 * основной класс с реализацией логики и консольного интерфейса
 * version 1.0
 */
    ...
    private void buyMenu(int id) {
        ...
        try {
            ...
            if (count > 0 & count < product.getCount()) {
                printMessage("Вы действительно хотите приобрести товар " + product.getName().trim() + " в количестве "
                        + count
                        + " штук, общей стоимостью " + product.getPrice() * count
