...
All URIs are relative to _http://localhost:8080/api/v1/_

| Class       | Method                                                         | HTTP request                  | Description                               |
| ----------- | -------------------------------------------------------------- | ----------------------------- | ----------------------------------------- |
| _CloudsApi_ | [**cancel_cloud_by_id**](docs/CloudsApi.md#cancel_cloud_by_id) | **DELETE** /clouds/{cloud_id} | Метод отмены заказа в облаке по ID        |
| _CloudsApi_ | [**create_cloud**](docs/CloudsApi.md#create_cloud)             | **POST** /clouds              | Создание заказа в облаке                  |
| _CloudsApi_ | [**get_all_clouds**](docs/CloudsApi.md#get_all_clouds)         | **GET** /clouds               | Метод получения списка ресурсов на облаке |
| _CloudsApi_ | [**get_cloud**](docs/CloudsApi.md#get_cloud)                   | **GET** /clouds/{cloud_id}    | Метод получения заказа по ID              |
