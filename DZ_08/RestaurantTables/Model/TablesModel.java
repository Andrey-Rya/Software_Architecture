    ...
    public String[][] getTablesStatus() {
        ...
        for (int hall = 0; hall < 2; hall++) {
            for (int table = 0; table < 3; table++) {
                status[hall][table] = tablesStatus[hall][table] ? "Забронировано" : "Свободно";
            }
        }
        return status;
    }
